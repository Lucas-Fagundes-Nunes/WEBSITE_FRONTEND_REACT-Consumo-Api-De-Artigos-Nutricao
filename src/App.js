   ...
   <div className='branco'>
      ...
      <footer>
       ...
       <li>
          ...
          <li>
          <svg xmlns="http://www.w3.org/2000/svg"  fill="blue" class="bi bi-messenger" viewBox="0 0 16 16">
          ...
          <li>
          <svg xmlns="http://www.w3.org/2000/svg"  fill="purple" class="bi bi-instagram" viewBox="0 0 16 16">
